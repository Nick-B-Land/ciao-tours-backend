...
public class daily_assistance_charges {
    ...
    public daily_assistance_charges(long daily_assistance_charges_id, long employee_id, Date startDate, Date endDate, float rate_daily_Assistance, float total_rate) {
    ...
    public boolean equals(Object o) {
        ...
        return getDaily_assistance_charges_id() == that.getDaily_assistance_charges_id() && getEmployee_id() == that.getEmployee_id() && Float.compare(that.getRate_daily_Assistance(), getRate_daily_Assistance()) == 0 && Float.compare(that.getTotal_rate(), getTotal_rate()) == 0 && getStartDate().equals(that.getStartDate()) && getEndDate().equals(that.getEndDate());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getDaily_assistance_charges_id(), getEmployee_id(), getStartDate(), getEndDate(), getRate_daily_Assistance(), getTotal_rate());
    }
